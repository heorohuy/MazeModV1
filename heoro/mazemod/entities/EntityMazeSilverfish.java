package heoro.mazemod.entities;
...
public class EntityMazeSilverfish extends EntityMob
{
    /**
    ...
    public EntityMazeSilverfish(World par1World)
    {
        super(par1World);
    ...
    public boolean getCanSpawnHere()
    {
        ...
        {
            return this.worldObj.getClosestPlayerToEntity(this, 5.0D) == null;
        }
        else
        {
            return false;
